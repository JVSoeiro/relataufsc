...
const initialMockComplaints: PublicComplaint[] = [
  {
    ...
    description:
      "Calçada quebrada perto de uma área de circulação intensa, com desnível visível e risco de tropeço. O trecho fica pior quando chove e acumula água, deixando o piso escorregadio. É um ponto de passagem para muitas pessoas ao longo do dia e precisa de manutenção. Relato longo para validar a rolagem no mobile: ao deslizar, a mídia e o texto devem se mover juntos, sem a imagem ficar estática por cima do conteúdo.",
    latitude: -27.6021,
    longitude: -48.5182,
    mediaKind: "image",
    mediaMimeType: "image/png",
    mediaUrl: "/ufsc_logo.png",
